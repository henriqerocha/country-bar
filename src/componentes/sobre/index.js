        ...
        <section id='sobre'>
            <div className='container-sobre'>
                <div className='titulo-sobre'>
                    <h2>Sobre <img src='./assets/sobre-emoticon-amarelo.webp' alt='icone email amarelo' className='emoticon-sobre'></img></h2>
                </div>
                <div className='box-sobre'>
                    <div className='img-sobre'>
                        <img src='./assets/foto-perfil.webp' alt='foto de perfil' className='img-perfil'></img>
                    </div>
